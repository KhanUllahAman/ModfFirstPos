...
class PinDialogField extends StatelessWidget {
  ...
  const PinDialogField({
    ...
    required this.label,
    this.cursorColor = ColorResources.appMainColor,
    this.selectionHandleColor = ColorResources.appMainColor,
  });
    ...
    return Padding(
      ...
      child: Theme(
        ...
        child: TextField(
          ...
          cursorColor: cursorColor, // Direct cursor color
    ...
    return Dialog(
      ...
      child: ConstrainedBox(
        constraints: BoxConstraints(
          maxWidth: 380,
          maxHeight:
              MediaQuery.of(context).size.height * 0.8, // <-- bounded height
        ),
        child: Container(
